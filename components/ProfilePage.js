  ...
  return (
    <>
      ...
      <>
        ...
        && <div id="toast-danger" className="w-full md:w-2/3 flex items-center max-w-xs p-4 text-gray-500 bg-red-500 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            <div className="ml-3 text-sm font-normal text-black">{emailError}</div>
