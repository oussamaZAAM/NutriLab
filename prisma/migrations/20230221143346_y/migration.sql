...
*/
-- DropForeignKey
ALTER TABLE "NutriInfo" DROP CONSTRAINT "NutriInfo_userId_fkey";

-- DropForeignKey
ALTER TABLE "Nutrients" DROP CONSTRAINT "Nutrients_userId_fkey";

-- AlterTable
ALTER TABLE "NutriInfo" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Nutrients" ALTER COLUMN "userId" SET DATA TYPE TEXT;
